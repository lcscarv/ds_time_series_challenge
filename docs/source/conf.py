...
# time_series_indicium documentation build
...
from time_series_indicium import __version__ as release

# -- Project information -----------------------------------------------------

project = "time_series_indicium"
author = "Kedro"
...
htmlhelp_basename = "time_series_indiciumdoc"
...
latex_documents = [
    (
        master_doc,
        "time_series_indicium.tex",
        "time_series_indicium Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "time_series_indicium",
        "Project time_series_indicium codebase.",
        "Data-Science",
    )
]
